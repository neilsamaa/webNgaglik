...
@section('title', 'Fasilitas Ekonomi Desa Ngaglik')
...
{{-- Body Awal --}}
  ...
  <div class="row">
    ...
    <div class="col-md-8 border rounded pt-4" style="text-align: justify">
      <hr>
      <h1 class="text-center">FASILITAS EKONOMI</h1>
      <hr>

      <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
          <button class="nav-link active" id="nav-hotel-tab" data-bs-toggle="tab" data-bs-target="#nav-hotel" type="button" role="tab" aria-controls="nav-hotel" aria-selected="true">Hotel</button>
        ...
        <div class="tab-pane fade show active" id="nav-hotel" role="tabpanel" aria-labelledby="nav-hotel-tab">
          ...
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              <tr>
                <th scope="row">1</th>
                <td>HORISSON / AMARTAHIL</td>
                <td>Jl. Abdul Gani Atas RW 15</td>
              </tr>
              <tr>
                <th scope="row">2</th>
                <td>AGRO WISATA HOTEL</td>
                <td>Jl. Abdul Gani Atas RW 15</td>
              </tr>
              <tr>
                <th scope="row">3</th>
